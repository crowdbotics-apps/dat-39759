"""
Django settings for dat_39759 project.
...
WSGI_APPLICATION = 'dat_39759.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dat_39759 API",
    "DESCRIPTION": "API documentation for dat_39759 App",
    "VERSION": "v1",
}
